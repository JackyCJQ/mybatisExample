...
import com.jacky.cache.dao.DepartmentMapper;
import com.jacky.cache.dao.EmployeeMapper;
import com.jacky.cache.dao.EmployeeMapperPlus;
...
public class MyBatisTest {
    ...
    public void testFirstLevelCache() throws IOException {
        ...
        try {
            ...
            SqlSession openSession2 = sqlSessionFactory.openSession();
            EmployeeMapper mapper2 = openSession2.getMapper(EmployeeMapper.class);
            Employee employee = mapper2.getEmpById(1);
            System.out.println(employee);
            System.out.println(emp01 == employee);
            openSession2.close();

            //2、sqlSession相同，查询条件不同
            //3、sqlSession相同，两次查询之间执行了增删改操作(这次增删改可能对当前数据有影响),会清除本地缓存，重新发起sql请求
...
//			System.out.println(emp01==emp02);
    ...
    @Test
    public void testDeffer() throws IOException {
        SqlSessionFactory sqlSessionFactory = getSqlSessionFactory();
        SqlSession openSession = sqlSessionFactory.openSession();
        try {
            //1、
